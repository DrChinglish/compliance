...
class YOLO(ONNXModel): 
    def __init__(self, onnx_path="media/files/platformapi/onnx_server/best.onnx"):
        ...
        self.num_classes = 3
        self.classes = ['skull', 'iris', 'auricle', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light',
