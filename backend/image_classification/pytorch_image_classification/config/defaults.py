...
config.albu=ConfigNode()
config.albu.RandomSizedBBoxSafeCrop=ConfigNode()
config.albu.RandomSizedBBoxSafeCrop.height=680
config.albu.RandomSizedBBoxSafeCrop.width=680
config.albu.RandomSizedBBoxSafeCrop.p=0.8
...
config.train.seed = 0
config.train.val_first = False # True
